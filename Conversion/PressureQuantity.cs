            ...
            UnitChoices = new List<UnitChoice>()
      {
       ...
       new UnitChoice
          ...
          new UnitChoice
        {
         ...
         new UnitChoice
        {
          UnitName = "NewtonPerSquareMillimetre",
          UnitLabel = "N/mm²",
        ...
        new UnitChoice
        {
          UnitName = "KiloNewtonPerSquareMetre",
          UnitLabel = "kN/m²",
        ...
        new UnitChoice
        {
          UnitName = "CentimetreMercuryZeroDegC",
          UnitLabel = "cm Hg 0°C",
        ...
        new UnitChoice
        {
          UnitName = "MillimetreMercuryZeroDegC",
          UnitLabel = "mm Hg 0°C",
        ...
        new UnitChoice
        {
          UnitName = "DynesPerSquareCentimetre",
          UnitLabel = "dynes/cm²",
