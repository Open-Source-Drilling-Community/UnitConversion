...
namespace OSDC.UnitConversion.Conversion
{
    public partial class AccelerationQuantity : DerivedBasePhysicalQuantity
    {
        ...
        public override string SIUnitName { get; } = "MetrePerSecondSquare";
        ...
        public AccelerationQuantity() : base()
        {
            ...
            UnitChoices = new List<UnitChoice>()
            {
                ...
                new UnitChoice
                {
                  UnitName = "CentimetrePerSecondSquare",
                  UnitLabel = "cm/s²",
                 ...
                 new UnitChoice
                {
                  UnitName = "CentimetrePerHourPerSecond",
                  UnitLabel = "cm/(h.s)",
                ...
                new UnitChoice
                {
                  UnitName = "CentimetrePerMinutePerSecond",
                  UnitLabel = "cm/(min.s)",
                ...
                new UnitChoice
                {
                  UnitName = "MetrePerSecondPerMillisecond",
                  UnitLabel = "m/(s.ms)",
                ...
                new UnitChoice
                {
                  UnitName = "KilometrePerSecondSquare",
                  UnitLabel = "km/s²",
                ...
                new UnitChoice
                {
                  UnitName = "KilometrePerHourPerSecond",
                  UnitLabel = "km/(h.s)",
                ...
                new UnitChoice
                {
                  UnitName = "KilometrePerMinutePerSecond",
                  UnitLabel = "km/(min.s)",
