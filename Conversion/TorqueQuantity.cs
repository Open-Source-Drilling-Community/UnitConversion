...
namespace OSDC.UnitConversion.Conversion
{
    public partial class TorqueQuantity : DerivedBasePhysicalQuantity
    {
        ...
        public override string SIUnitName { get; } = "MetreNewton";
