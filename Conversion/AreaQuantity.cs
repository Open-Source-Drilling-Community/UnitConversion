...
namespace OSDC.UnitConversion.Conversion
{
    public partial class AreaQuantity : DerivedBasePhysicalQuantity
    {
        ...
        public override string SIUnitName { get; } = "SquareMetre";
