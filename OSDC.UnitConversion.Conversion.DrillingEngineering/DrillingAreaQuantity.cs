...
{
    public partial class DrillingAreaQuantity : AreaQuantity, IEngineeringQuantity
    {
        public virtual double? MeaningFullPrecisionInSI { get; } = 1e-6;
        ...
        protected DrillingAreaQuantity() : base()
        {
            Name = "DrillingArea";
