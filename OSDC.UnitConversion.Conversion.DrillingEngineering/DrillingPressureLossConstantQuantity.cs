...
{
    public partial class DrillingPressureLossConstantQuantity : PressureLossConstantQuantity, IEngineeringQuantity
    {
        ...
        protected DrillingPressureLossConstantQuantity() : base()
        {
