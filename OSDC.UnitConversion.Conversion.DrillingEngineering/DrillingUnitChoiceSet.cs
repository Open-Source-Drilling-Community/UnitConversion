            ...
            if (quantities != null)
            {
                ...
                */
                ...
                else if (defaultUnitChoice == UnitChoice.DefaultUnitSetChoiceEnum.Metric)
                {
                    ...
                    Choices.Add(DrillingSurveyInstrumentAngularVelocityQuantity.Instance.ID.ToString(), DrillingSurveyInstrumentAngularVelocityQuantity.Instance.GetUnitChoice(DrillingSurveyInstrumentAngularVelocityQuantity.UnitChoicesEnum.DegreePerHour).ID.ToString());
                    Choices.Add(DrillingSurveyInstrumentAngleMagneticFluxDensityQuantity.Instance.ID.ToString(), DrillingSurveyInstrumentAngleMagneticFluxDensityQuantity.Instance.GetUnitChoice(DrillingSurveyInstrumentAngleMagneticFluxDensityQuantity.UnitChoicesEnum.DegreeNanoTesla).ID.ToString());
                    Choices.Add(DrillingSurveyInstrumentReciprocalLengthQuantity.Instance.ID.ToString(), DrillingSurveyInstrumentReciprocalLengthQuantity.Instance.GetUnitChoice(DrillingSurveyInstrumentReciprocalLengthQuantity.UnitChoicesEnum.ReciprocalKilometer).ID.ToString());
                    ...
                    Choices.Add(DrillingDrillStringMagneticFluxQuantity.Instance.ID.ToString(), DrillingDrillStringMagneticFluxQuantity.Instance.GetUnitChoice(DrillingDrillStringMagneticFluxQuantity.UnitChoicesEnum.MicroWeber).ID.ToString());
                    ...
                    Choices.Add(DrillingStickDurationQuantity.Instance.ID.ToString(), DrillingStickDurationQuantity.Instance.GetUnitChoice(DrillingStickDurationQuantity.UnitChoicesEnum.Second).ID.ToString());
                    ...
                    Choices.Add(DrillingPowerQuantity.Instance.ID.ToString(), DrillingPowerQuantity.Instance.GetUnitChoice(DrillingPowerQuantity.UnitChoicesEnum.Watt).ID.ToString());
                    ...
                    Choices.Add(DrillingMassGradientQuantity.Instance.ID.ToString(), DrillingMassGradientQuantity.Instance.GetUnitChoice(DrillingMassGradientQuantity.UnitChoicesEnum.KilogramPerMeter).ID.ToString());
                    ...
                    Choices.Add(DrillingRandomWalkQuantity.Instance.ID.ToString(), DrillingRandomWalkQuantity.Instance.GetUnitChoice(DrillingRandomWalkQuantity.UnitChoicesEnum.DegreePerSqrtHour).ID.ToString());
