...
{
    public partial class DrillingCompressibilityQuantity : CompressibilityQuantity, IEngineeringQuantity
    {
        public double? MeaningFullPrecisionInSI { get; } = 1E-13;
        ...
        protected DrillingCompressibilityQuantity() : base()
        {
