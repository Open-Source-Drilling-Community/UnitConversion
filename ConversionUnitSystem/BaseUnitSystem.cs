            ...
            if (quantities != null)
            {
                ...
                */
                ...
                else if (defaultUnitChoice == DefaultUnitSystemEnum.Metric)
                {
                    ...
                    Choices.Add(SmallTorqueQuantity.Instance.ID.ToString(), SmallTorqueQuantity.Instance.GetUnitChoice(SmallTorqueQuantity.UnitChoicesEnum.NewtonMillimetre).ID.ToString());
                    ...
                    Choices.Add(SpecificHeatCapacityTemperatureGradientQuantity.Instance.ID.ToString(), SpecificHeatCapacityTemperatureGradientQuantity.Instance.GetUnitChoice(SpecificHeatCapacityTemperatureGradientQuantity.UnitChoicesEnum.JoulePerKilogramSquaredKelvin).ID.ToString());
                    ...
                    Choices.Add(TorqueGradientQuantity.Instance.ID.ToString(), TorqueGradientQuantity.Instance.GetUnitChoice(TorqueGradientQuantity.UnitChoicesEnum.NewtonMetrePerMetre).ID.ToString());
                ...
                else if (defaultUnitChoice == DefaultUnitSystemEnum.US)
                {
                    ...
                    Choices.Add(SpecificHeatCapacityTemperatureGradientQuantity.Instance.ID.ToString(), SpecificHeatCapacityTemperatureGradientQuantity.Instance.GetUnitChoice(SpecificHeatCapacityTemperatureGradientQuantity.UnitChoicesEnum.BritishThermalUnitPerPoundSquaredDegreeFahrenheit).ID.ToString());
                    Choices.Add(StandardDimensionlessQuantity.Instance.ID.ToString(), StandardDimensionlessQuantity.Instance.GetUnitChoice(StandardDimensionlessQuantity.UnitChoicesEnum.Dimensionless).ID.ToString());
                    ...
                    Choices.Add(ThermalConductivityTemperatureGradientQuantity.Instance.ID.ToString(), ThermalConductivityTemperatureGradientQuantity.Instance.GetUnitChoice(ThermalConductivityTemperatureGradientQuantity.UnitChoicesEnum.BritishThermalUnitInchPerHourSquareFootDegreeFahrenheitSquared).ID.ToString());
                    Choices.Add(TimeQuantity.Instance.ID.ToString(), TimeQuantity.Instance.GetUnitChoice(TimeQuantity.UnitChoicesEnum.Second).ID.ToString());
                    ...
                    Choices.Add(TorqueGradientQuantity.Instance.ID.ToString(), TorqueGradientQuantity.Instance.GetUnitChoice(TorqueGradientQuantity.UnitChoicesEnum.FootPoundPerFoot).ID.ToString());
                ...
                else if (defaultUnitChoice == DefaultUnitSystemEnum.Imperial)
                {
                    ...
                    Choices.Add(CurvatureQuantity.Instance.ID.ToString(), CurvatureQuantity.Instance.GetUnitChoice(CurvatureQuantity.UnitChoicesEnum.DegreePer100ft).ID.ToString());
                    Choices.Add(DensityGradientDepthQuantity.Instance.ID.ToString(), DensityGradientDepthQuantity.Instance.GetUnitChoice(DensityGradientDepthQuantity.UnitChoicesEnum.PoundPerGallonUKPer100Foot).ID.ToString());
                    Choices.Add(DensityGradientTemperatureQuantity.Instance.ID.ToString(), DensityGradientTemperatureQuantity.Instance.GetUnitChoice(DensityGradientTemperatureQuantity.UnitChoicesEnum.PoundPerGallonUKPerCelsius).ID.ToString());
