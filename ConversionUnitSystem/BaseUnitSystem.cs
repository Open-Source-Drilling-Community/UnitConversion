            ...
            if (quantities != null)
            {
                ...
                */
                ...
                else if (defaultUnitChoice == DefaultUnitSystemEnum.Metric)
                {
                    ...
                    Choices.Add(MassDensityGradientPerPressureQuantity.Instance.ID.ToString(), MassDensityGradientPerPressureQuantity.Instance.GetUnitChoice(MassDensityGradientPerPressureQuantity.UnitChoicesEnum.GramPerCubicCentimetrePerBar).ID.ToString());
                    Choices.Add(MassDensityGradientPerPressureSquaredQuantity.Instance.ID.ToString(), MassDensityGradientPerPressureSquaredQuantity.Instance.GetUnitChoice(MassDensityGradientPerPressureSquaredQuantity.UnitChoicesEnum.GramPerCubicCentimetrePerBarSquared).ID.ToString());
                    Choices.Add(MassDensityGradientPerPressureSquaredTemperatureQuantity.Instance.ID.ToString(), MassDensityGradientPerPressureSquaredTemperatureQuantity.Instance.GetUnitChoice(MassDensityGradientPerPressureSquaredTemperatureQuantity.UnitChoicesEnum.GramPerCubicCentimetrePerBarSquaredCelsius).ID.ToString());
                    Choices.Add(MassDensityGradientPerPressureTemperatureQuantity.Instance.ID.ToString(), MassDensityGradientPerPressureTemperatureQuantity.Instance.GetUnitChoice(MassDensityGradientPerPressureTemperatureQuantity.UnitChoicesEnum.GramPerCubicCentimetrePerBarCelsius).ID.ToString());
