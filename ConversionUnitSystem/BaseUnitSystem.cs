            ...
            if (quantities != null)
            {
                ...
                */
                ...
                else if (defaultUnitChoice == DefaultUnitSystemEnum.Metric)
                {
                    ...
                    Choices.Add(SpecificHeatCapacityGradientPerTemperatureQuantity.Instance.ID.ToString(), SpecificHeatCapacityGradientPerTemperatureQuantity.Instance.GetUnitChoice(SpecificHeatCapacityGradientPerTemperatureQuantity.UnitChoicesEnum.JoulePerKilogramSquaredKelvin).ID.ToString());
                ...
                else if (defaultUnitChoice == DefaultUnitSystemEnum.US)
                {
                    ...
                    Choices.Add(ForceGradientPerLengthQuantity.Instance.ID.ToString(), ForceGradientPerLengthQuantity.Instance.GetUnitChoice(ForceGradientPerLengthQuantity.UnitChoicesEnum.DecanewtonPerMetre).ID.ToString());
                    ...
                    Choices.Add(SpecificHeatCapacityGradientPerTemperatureQuantity.Instance.ID.ToString(), SpecificHeatCapacityGradientPerTemperatureQuantity.Instance.GetUnitChoice(SpecificHeatCapacityGradientPerTemperatureQuantity.UnitChoicesEnum.BritishThermalUnitPerPoundSquaredDegreeFahrenheit).ID.ToString());
                    Choices.Add(DimensionLessStandardQuantity.Instance.ID.ToString(), DimensionLessStandardQuantity.Instance.GetUnitChoice(DimensionLessStandardQuantity.UnitChoicesEnum.Dimensionless).ID.ToString());
