namespace OSDC.UnitConversion.WebApp.Utils
{
    public static class APIUtils
    {
        ...
        public static readonly ModelShared.Client ClientUnitConversion = new(APIUtils.HttpClientUnitConversion.BaseAddress!.ToString(), APIUtils.HttpClientUnitConversion);
