            ...
            if (quantities != null)
            {
                ...
                */
                ...
                else if (defaultUnitChoice == BaseUnitSystem.DefaultUnitSystemEnum.Metric)
                {
                    ...
                    Choices.Add(HookLoadDrillingQuantity.Instance.ID.ToString(), HookLoadDrillingQuantity.Instance.GetUnitChoice(HookLoadDrillingQuantity.UnitChoicesEnum.TonneMetric).ID.ToString());
                    ...
                    Choices.Add(SpecificHeatCapacityGradientPerTemperatureDrillingQuantity.Instance.ID.ToString(), SpecificHeatCapacityGradientPerTemperatureDrillingQuantity.Instance.GetUnitChoice(SpecificHeatCapacityGradientPerTemperatureDrillingQuantity.UnitChoicesEnum.JoulePerKilogramSquaredKelvin).ID.ToString());
                    ...
                    Choices.Add(WeightOnBitDrillingQuantity.Instance.ID.ToString(), WeightOnBitDrillingQuantity.Instance.GetUnitChoice(WeightOnBitDrillingQuantity.UnitChoicesEnum.TonneMetric).ID.ToString());
                }
                else if (defaultUnitChoice == BaseUnitSystem.DefaultUnitSystemEnum.US)
                {
                    ...
                    Choices.Add(HookLoadDrillingQuantity.Instance.ID.ToString(), HookLoadDrillingQuantity.Instance.GetUnitChoice(HookLoadDrillingQuantity.UnitChoicesEnum.Kilopound).ID.ToString());
                    ...
                    Choices.Add(SpecificHeatCapacityGradientPerTemperatureDrillingQuantity.Instance.ID.ToString(), SpecificHeatCapacityGradientPerTemperatureDrillingQuantity.Instance.GetUnitChoice(SpecificHeatCapacityGradientPerTemperatureDrillingQuantity.UnitChoicesEnum.BritishThermalUnitPerPoundSquaredDegreeFahrenheit).ID.ToString());
                    Choices.Add(StickDurationDrillingQuantity.Instance.ID.ToString(), StickDurationDrillingQuantity.Instance.GetUnitChoice(StickDurationDrillingQuantity.UnitChoicesEnum.Second).ID.ToString());
                    Choices.Add(AngularVelocitySurveyInstrumentDrillingQuantity.Instance.ID.ToString(), AngularVelocitySurveyInstrumentDrillingQuantity.Instance.GetUnitChoice(AngularVelocitySurveyInstrumentDrillingQuantity.UnitChoicesEnum.DegreePerHour).ID.ToString());
                    Choices.Add(AngleMagneticFluxDensitySurveyInstrumentDrillingQuantity.Instance.ID.ToString(), AngleMagneticFluxDensitySurveyInstrumentDrillingQuantity.Instance.GetUnitChoice(AngleMagneticFluxDensitySurveyInstrumentDrillingQuantity.UnitChoicesEnum.DegreeNanotesla).ID.ToString());
                    Choices.Add(ReciprocalLengthSurveyInstrumentDrillingQuantity.Instance.ID.ToString(), ReciprocalLengthSurveyInstrumentDrillingQuantity.Instance.GetUnitChoice(ReciprocalLengthSurveyInstrumentDrillingQuantity.UnitChoicesEnum.ReciprocalKilometre).ID.ToString());
                    ...
                    Choices.Add(WeightOnBitDrillingQuantity.Instance.ID.ToString(), WeightOnBitDrillingQuantity.Instance.GetUnitChoice(WeightOnBitDrillingQuantity.UnitChoicesEnum.Kilopound).ID.ToString());
                }
