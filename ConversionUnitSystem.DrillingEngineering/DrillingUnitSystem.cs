            ...
            if (quantities != null)
            {
                ...
                */
                ...
                else if (defaultUnitChoice == BaseUnitSystem.DefaultUnitSystemEnum.Metric)
                {
                    ...
                    Choices.Add(MassDensityGradientPerPressureDrillingQuantity.Instance.ID.ToString(), MassDensityGradientPerPressureDrillingQuantity.Instance.GetUnitChoice(MassDensityGradientPerPressureDrillingQuantity.UnitChoicesEnum.GramPerCubicCentimetrePerBar).ID.ToString());
                    Choices.Add(MassDensityGradientPerPressureSquaredDrillingQuantity.Instance.ID.ToString(), MassDensityGradientPerPressureSquaredDrillingQuantity.Instance.GetUnitChoice(MassDensityGradientPerPressureSquaredDrillingQuantity.UnitChoicesEnum.GramPerCubicCentimetrePerBarSquared).ID.ToString());
                    Choices.Add(MassDensityGradientPerPressureSquaredTemperatureDrillingQuantity.Instance.ID.ToString(), MassDensityGradientPerPressureSquaredTemperatureDrillingQuantity.Instance.GetUnitChoice(MassDensityGradientPerPressureSquaredTemperatureDrillingQuantity.UnitChoicesEnum.GramPerCubicCentimetrePerBarSquaredCelsius).ID.ToString());
                    Choices.Add(MassDensityGradientPerPressureTemperatureDrillingQuantity.Instance.ID.ToString(), MassDensityGradientPerPressureTemperatureDrillingQuantity.Instance.GetUnitChoice(MassDensityGradientPerPressureTemperatureDrillingQuantity.UnitChoicesEnum.GramPerCubicCentimetrePerBarCelsius).ID.ToString());
