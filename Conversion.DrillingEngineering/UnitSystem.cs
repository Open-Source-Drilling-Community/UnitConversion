            ...
            if (quantities != null)
            {
                ...
                */
                ...
                else if (defaultUnitChoice == BaseUnitSystem.DefaultUnitSystemEnum.Metric)
                {
                    ...
                    Choices.Add(ElongationGradientDrillingQuantity.Instance.ID.ToString(), ElongationGradientDrillingQuantity.Instance.GetUnitChoice(ElongationGradientDrillingQuantity.UnitChoicesEnum.MillimetrePerKilometre).ID.ToString()); ;
                    ...
                    Choices.Add(GasVolumetricFlowRateQuantity.Instance.ID.ToString(), GasVolumetricFlowRateQuantity.Instance.GetUnitChoice(GasVolumetricFlowRateQuantity.UnitChoicesEnum.LitrePerMinute).ID.ToString());
                    ...
                    Choices.Add(NozzleDiameterQuantity.Instance.ID.ToString(), NozzleDiameterQuantity.Instance.GetUnitChoice(NozzleDiameterQuantity.UnitChoicesEnum.InchPer32).ID.ToString());
                    ...
                    Choices.Add(TorqueGradientDrillingQuantity.Instance.ID.ToString(), TorqueGradientDrillingQuantity.Instance.GetUnitChoice(TorqueGradientDrillingQuantity.UnitChoicesEnum.NewtonMetrePerMetre).ID.ToString());
                ...
                else if (defaultUnitChoice == BaseUnitSystem.DefaultUnitSystemEnum.US)
                {
                    ...
                    Choices.Add(DensityRateOfChangeDrillingQuantity.Instance.ID.ToString(), DensityRateOfChangeDrillingQuantity.Instance.GetUnitChoice(DensityRateOfChangeDrillingQuantity.UnitChoicesEnum.PoundPerGallonUSPerSecond).ID.ToString());
                    ...
                    Choices.Add(DurationDrillingQuantity.Instance.ID.ToString(), DurationDrillingQuantity.Instance.GetUnitChoice(DurationDrillingQuantity.UnitChoicesEnum.Second).ID.ToString());
                    Choices.Add(DynamicViscosityDrillingQuantity.Instance.ID.ToString(), DynamicViscosityDrillingQuantity.Instance.GetUnitChoice(DynamicViscosityDrillingQuantity.UnitChoicesEnum.PascalSecond).ID.ToString());
                    Choices.Add(ElongationGradientDrillingQuantity.Instance.ID.ToString(), ElongationGradientDrillingQuantity.Instance.GetUnitChoice(ElongationGradientDrillingQuantity.UnitChoicesEnum.InchPerMile).ID.ToString()); ;
                    ...
                    Choices.Add(PipeDiameterQuantity.Instance.ID.ToString(), PipeDiameterQuantity.Instance.GetUnitChoice(PipeDiameterQuantity.UnitChoicesEnum.Inch).ID.ToString());
                    Choices.Add(PlaneAngleDrillingQuantity.Instance.ID.ToString(), PlaneAngleDrillingQuantity.Instance.GetUnitChoice(PlaneAngleDrillingQuantity.UnitChoicesEnum.Degree).ID.ToString());
                    Choices.Add(PoreDiameterQuantity.Instance.ID.ToString(), PoreDiameterQuantity.Instance.GetUnitChoice(PoreDiameterQuantity.UnitChoicesEnum.InchPer32).ID.ToString());
                    Choices.Add(PoreSurfaceQuantity.Instance.ID.ToString(), PoreSurfaceQuantity.Instance.GetUnitChoice(PoreSurfaceQuantity.UnitChoicesEnum.SquareMicrometre).ID.ToString());
                    ...
                    Choices.Add(TorqueGradientDrillingQuantity.Instance.ID.ToString(), TorqueGradientDrillingQuantity.Instance.GetUnitChoice(TorqueGradientDrillingQuantity.UnitChoicesEnum.FootPoundPerFoot).ID.ToString());
                ...
                else if (defaultUnitChoice == BaseUnitSystem.DefaultUnitSystemEnum.Imperial)
                {
                    ...
                    Choices.Add(DensityGradientTemperatureDrillingQuantity.Instance.ID.ToString(), DensityGradientTemperatureDrillingQuantity.Instance.GetUnitChoice(DensityGradientTemperatureDrillingQuantity.UnitChoicesEnum.PoundPerGallonUKPerCelsius).ID.ToString());
