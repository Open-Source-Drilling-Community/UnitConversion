...
namespace OSDC.UnitConversion.Conversion
{
    public partial class PressureQuantity : DerivedPhysicalQuantity
    {
        ...
        public override string SIUnitSymbol { get; } = "Pa";
