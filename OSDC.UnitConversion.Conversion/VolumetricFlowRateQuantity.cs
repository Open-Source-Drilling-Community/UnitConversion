...
namespace OSDC.UnitConversion.Conversion
{
    public partial class VolumetricFlowRateQuantity : DerivedPhysicalQuantity
    {
        ...
        public override string SIUnitName { get; } = "CubicMeterPerSecond";
        ...
        protected VolumetricFlowRateQuantity() : base()
        {
            Name = "FlowRate";
            ...
            UnitChoices = new List<UnitChoice>()
      {
        ...
        new UnitChoice
        {
          UnitName = "MillionCubicMeterPerDay",
          UnitSymbol = "Mm³/d",
        ...
        new UnitChoice
        {
          ...
          UnitSymbol = "MillionUKGallonPerDay",
        ...
        new UnitChoice
        {
          ...
          UnitSymbol = "MillionUSGallonPerDay",
