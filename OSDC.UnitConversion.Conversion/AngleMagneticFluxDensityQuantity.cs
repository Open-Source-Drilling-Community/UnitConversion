...
namespace OSDC.UnitConversion.Conversion
{
    public partial class AngleMagneticFluxDensityQuantity : DerivedPhysicalQuantity
    {
            ...
            UnitChoices = new List<UnitChoice>()
      {
        ...
        new UnitChoice
        {
          UnitName = "RadianMaxwellPerSquareCentimeter",
          UnitLabel = "rd.Mx/cm²",
        ...
        new UnitChoice
        {
          UnitName = "RadianWeberPerSquareMeter",
          UnitLabel = "rd.Wb/m²",
        ...
        new UnitChoice
        {
          UnitName = "DegreeMaxwellPerSquareCentimeter",
          UnitLabel = "°.Mx/cm²",
        ...
        new UnitChoice
        {
          UnitName = "DegreeWeberPerSquareMeter",
          UnitLabel = "°.Wb/m²",
