...
namespace OSDC.UnitConversion.Conversion
{
    public partial class DensitySpeedQuantity : DerivedPhysicalQuantity
    {
        ...
        public override string SIUnitSymbol { get; } = "kg/m³/s";
        public override double MassDimension { get; } = 1;
        public override double LengthDimension { get; } = -3;
        public override double TimeDimension { get; } = -1;
        private static DensitySpeedQuantity instance_ = null;

        public static DensitySpeedQuantity Instance
        {
            get
            {
                if (instance_ == null)
                {
                    instance_ = new DensitySpeedQuantity();
                }
                return instance_;
            }
        }
        protected DensitySpeedQuantity() : base()
        {
            Name = "DensitySpeed";
