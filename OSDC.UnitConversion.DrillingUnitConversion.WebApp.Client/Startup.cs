...
namespace OSDC.UnitConversion.DrillingUnitConversion.WebApp.Client
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UsePathBase("/DrillingUnitConversion/webapp");

            if (!String.IsNullOrEmpty(Configuration["DrillingUnitConversionHostURL"]))
                OSDC.UnitConversion.DrillingUnitConversion.WebApp.Client.Configuration.DrillingUnitConversionHostURL = Configuration["DrillingUnitConversionHostURL"];
